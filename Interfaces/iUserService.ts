...
export interface IUserService {
  ...
  // getDoctors(page:number,limit:number,search:string,department:string): Promise<User[]>;
  ...
  // getAppointmentDetails(userId: string): Promise<AppointmentDetails[]>;
  ...
  // getcancelandcompleteAppointmentDetails(userId: string): Promise<AppointmentDetails[]>;
